...
def create_app(config_name: str | None = None) -> Flask:
    ...
    def set_security_headers(response):
        ...
        # Allow geolocation for pickup/dropoff picker
    ...
    def inject_globals():
        ...
        try:
            ...
            # Inject CMS data site-wide (cached at request level via g)
            from flask import g
            if not hasattr(g, "_cms"):
                doc = db.cms.find_one({"_id": "site_content"}) or {}
                g._cms = doc
            cms_data = g._cms
        except Exception:
            pass
        return {"unread_notifications": unread, "site": cms_data}
